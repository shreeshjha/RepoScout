    ...
    F: FnMut(
        ...
        Box<
            dyn std::future::Future<
                    Output = anyhow::Result<Vec<reposcout_core::models::Repository>>,
                > + '_,
        >,
    >,
{
                    ...
                    match app.input_mode {
                                        ...
                                        SearchMode::Repository | SearchMode::Trending => {
                                            ...
                                            match on_search(&query).await {
                                                Ok(results) => {
                                                    ...
                                                    tokio::spawn(async move {
                                                        use reposcout_semantic::{
                                                            SemanticConfig, SemanticSearchEngine,
                                                        };
                                                    ...
                                                    if let Err(e) = cache.add_search_history(
                                                        &app.search_input,
                                                        None,
                                                        Some(result_count as i64),
                                                    ) {
                                                        tracing::warn!(
                                                ...
                                                Err(e) => {
                                                    ...
                                                    let error_message = if error_str
                                                        .contains("Network")
                                        ...
                                        SearchMode::Code => {
                                            ...
                                            match github_client.search_code(&query, 30).await {
                                                ...
                                                Err(e) => {
                                                    ...
                                                    {
                                                        "API response error. Try again later."
                                                            .to_string()
                                                    } else {
                        ...
                        InputMode::HistoryPopup => match key.code {
                            ...
                            KeyCode::Enter => {
                                ...
                                if let Some(_query) = app.apply_selected_history() {
                                    app.exit_history_popup();
                                    ...
                                    match app.search_mode {
                                        ...
                                        SearchMode::Code => {
                                            ...
                                            app.error_message = Some(
                                                "Code search history not yet supported".to_string(),
                                            );
                                            app.loading = false;
                                        }
                                        SearchMode::Notifications => {
                            ...
                            if app.show_trending_options && app.search_mode == SearchMode::Trending
                            {
                                match key.code {
                                    ...
                                    KeyCode::Backspace => {
                                        ...
                                        if app.trending_option_cursor == 1 {
                                            if let Some(ref mut lang) =
                                                app.trending_filters.language
                                            {
                                                lang.pop();
                                                if lang.is_empty() {
                                ...
                                && key.code == KeyCode::Char('r')
                            {
                                ...
                                if let Ok(history) = cache.get_search_history(20) {
                                    if !history.is_empty() {
                                        ...
                                        app.set_temp_error(
                                            "No search history available (Press Esc to dismiss)"
                                                .to_string(),
                                        );
                                    }
                                } else {
                                    app.set_temp_error(
                                        "Failed to load search history (Press Esc to dismiss)"
                                            .to_string(),
                                    );
                                }
                                continue;
                            ...
                            match key.code {
                                ...
                                KeyCode::Char('/') => {
                                    ...
                                    if app.search_mode != SearchMode::Trending
                                        && app.search_mode != SearchMode::Notifications
                                    {
                                ...
                                KeyCode::Enter => {
                                    ...
                                    if app.search_mode == SearchMode::Trending {
                                        ...
                                        let period = match app.trending_filters.period {
                                            ...
                                            crate::app::TrendingPeriod::Weekly => {
                                                CorePeriod::Weekly
                                            }
                                            crate::app::TrendingPeriod::Monthly => {
                                                CorePeriod::Monthly
                                            }
                                        };
                                        ...
                                        match on_search(&query).await {
                                            Ok(mut results) => {
                                                ...
                                                if app.trending_filters.sort_by_velocity {
                                                    results.sort_by(|a, b| {
                                                        let age_a = (chrono::Utc::now()
                                                            - a.created_at)
                                                            .num_days()
                                                            .max(1)
                                                            as f64;
                                                        let age_b = (chrono::Utc::now()
                                                            - b.created_at)
                                                            .num_days()
                                                            .max(1)
                                                            as f64;
                                            ...
                                            Err(e) => {
                                                app.error_message =
                                                    Some(format!("Trending search failed: {}", e));
                                                app.loading = false;
                                            }
                                        }
                                        ...
                                        match app.discovery_category {
                                            ...
                                            crate::DiscoveryCategory::HiddenGems => {
                                                let query =
                                                    reposcout_core::discovery::hidden_gems_query(
                                                        None, 100,
                                                    );
                                                app.search_input = query.clone();
                                                app.search_mode = SearchMode::Repository;
                                            ...
                                            crate::DiscoveryCategory::Topics => {
                                                let topics =
                                                    reposcout_core::discovery::popular_topics();
                                                if let Some((topic, name)) =
                                                    topics.get(app.discovery_cursor)
                                                {
                                                    let query =
                                                        reposcout_core::discovery::topic_query(
                                                            topic, 10,
                                                        );
                                                    app.search_input = query.clone();
                                                    app.search_mode = SearchMode::Repository;
                                                    ...
                                                    app.set_error(
                                                        "DEBUG: No topic selected!".to_string(),
                                                    );
                                                }
                                            }
                                            crate::DiscoveryCategory::AwesomeLists => {
                                                let awesome_lists =
                                                    reposcout_core::discovery::awesome_lists();
                                                if let Some((repo, name)) =
                                                    awesome_lists.get(app.discovery_cursor)
                                                {
                                                    let url =
                                                    ...
                                                    app.set_error(
                                                        "DEBUG: No list selected!".to_string(),
                                                    );
                                                }
                                            }
                                        }
                                ...
                                KeyCode::Char('b') => {
                                    ...
                                    if let Some(repo) = app.selected_repository() {
                                        ...
                                        if app.is_current_bookmarked() {
                                            if let Err(e) = cache.add_bookmark(
                                                &platform,
                                                &full_name,
                                                &repo_clone,
                                                None,
                                                ...
                                                app.error_message =
                                                    Some(format!("Failed to bookmark: {}", e));
                                            }
                                        } else if let Err(e) =
                                            cache.remove_bookmark(&platform, &full_name)
                                        {
                                            app.error_message =
                                ...
                                KeyCode::Char('B') => {
                                    ...
                                    if app.show_bookmarks_only {
                                        // Load bookmarks
                                        if let Ok(bookmarks) = cache
                                            .get_bookmarks::<reposcout_core::models::Repository>(
                                        ) {
                                ...
                                KeyCode::Char('T') => {
                                    ...
                                    if app.show_theme_selector {
                                        ...
                                        let themes = reposcout_core::Theme::all_themes();
                                        app.theme_selector_index = themes
                                            .iter()
                                ...
                                KeyCode::Char('+') => {
                                    ...
                                    if let Some(_repo) = app.selected_repository() {
                                        if let Some(portfolio_id) =
                                            &app.selected_portfolio_id.clone()
                                        {
                                            match app.add_to_portfolio(portfolio_id, None, vec![]) {
                                                Ok(_) => {
                                                    app.set_temp_error(
                                                        "Added repository to portfolio".to_string(),
                                                    );
                                                }
                                                Err(e) => {
                                                    app.set_temp_error(format!(
                                            ...
                                            app.set_temp_error(
                                                "No portfolio selected. Press N to create one."
                                                    .to_string(),
                                            );
                                        }
                                    } else {
                                ...
                                KeyCode::Char('c') => {
                                    ...
                                    if (app.search_mode == SearchMode::Repository
                                        ...
                                        && app.preview_mode == crate::PreviewMode::Package
                                    {
                                    ...
                                    if app.search_mode == SearchMode::Discovery {
                                        ...
                                        if app.preview_mode == crate::PreviewMode::Package {
                                            if let Some(packages) =
                                                app.get_cached_package_info().cloned()
                                            {
                                                // Check if we need to fetch metadata
                                                let needs_fetch = packages
                                                    .iter()
                                                    .any(|pkg| pkg.latest_version.is_none());
                                                ...
                                                if needs_fetch {
                                                    ...
                                                    let registry_client =
                                                        reposcout_core::RegistryClient::new();
                                ...
                                KeyCode::Char('1') => {
                                    ...
                                    if app.search_mode == SearchMode::Discovery
                                        && app.discovery_category
                                            == crate::DiscoveryCategory::NewAndNotable
                                    {
                                        let query =
                                            reposcout_core::discovery::new_and_notable_query(
                                                None, 7,
                                            );
                                        app.search_input = query.clone();
                                        app.search_mode = SearchMode::Repository;
